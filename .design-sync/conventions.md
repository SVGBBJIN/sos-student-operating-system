...
| Brand accent | `--sos-accent` (cyan), `--sos-teal` |
| Status colors | `--sos-success`, `--sos-warning`, `--sos-danger` |
| Palette (charts, subject tags) | `--sos-green`, `--sos-blue`, `--sos-orange`, `--sos-pink`, `--sos-violet` |
...
are what keeps a generated design visually identical to the real SOS app.
