  ...
  if (user && !dataLoaded) {
    return (
      <div className="auth-screen" style={{position:'relative'}}>
        ...
        <div style={{fontSize:'2.2rem',fontWeight:900,background:'linear-gradient(135deg, #4de7f5 0%, #38d8e8 55%, #58b8ff 100%)',backgroundSize:'200% 200%',WebkitBackgroundClip:'text',WebkitTextFillColor:'transparent',marginBottom:16,position:'relative',animation:'gradientShift 3s ease infinite'}}>SOS</div>
