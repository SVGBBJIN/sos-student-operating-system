...
/* ── Notes view ──────────────────────────────────────────────── */
function NotesView({ notes, events, tasks, entityLinks, onCreateNote, onUpdateNote, onDeleteNote }) {
          ...
          <>
            ...
            {editing ? (
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0, overflowY: 'auto' }}>
                <div
                  style={{ padding: '12px 14px', color: 'var(--foreground)', fontFamily: 'var(--font-ui)', fontSize: 13, lineHeight: 1.65 }}
