...
const Icon = {
  ...
  copy:(s=18)=>I([{tag:'rect',x:'9',y:'9',width:'13',height:'13',rx:'2',ry:'2'},{tag:'path',d:'M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1'}],s),
  ...
  eye:(s=18)=>I(['M1 12s4-7 11-7 11 7 11 7-4 7-11 7-11-7-11-7z',{tag:'circle',cx:'12',cy:'12',r:'3'}],s),
  eyeOff:(s=18)=>I(['M17.94 17.94A10.93 10.93 0 0 1 12 19c-7 0-11-7-11-7a21.31 21.31 0 0 1 5.06-5.94','M9.9 4.24A10.94 10.94 0 0 1 12 5c7 0 11 7 11 7a21.1 21.1 0 0 1-2.16 3.19','M14.12 14.12a3 3 0 1 1-4.24-4.24','M1 1l22 22'],s),
  gripVertical:(s=18)=>I([{tag:'circle',cx:'9',cy:'6',r:'1'},{tag:'circle',cx:'15',cy:'6',r:'1'},{tag:'circle',cx:'9',cy:'12',r:'1'},{tag:'circle',cx:'15',cy:'12',r:'1'},{tag:'circle',cx:'9',cy:'18',r:'1'},{tag:'circle',cx:'15',cy:'18',r:'1'}],s),
